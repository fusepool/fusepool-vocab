...
<http:\/\/fusepool.info\/code\/filing-office\/$1> <http:\/\/www.w3.org\/2004\/02\/skos\/core#prefLabel> "$2"\@en ./' filing-office.txt > filing-office.nt
...
<http://fusepool.info/code/filing-office> <http://purl.org/dc/terms/source> <http://ep.espacenet.com/help?topic=countrycodes&locale=en_ep&method=handleHelpTopic> .' >> filing-office.nt
